...
print(parsedXml.testOne:name())
print(parsedXml.testOne.testTwo:value())
...
-- node functions test
local node = require("xml_simple").newNode("testName")
...
local childNode = require("xml_simple").newNode("parent")
